...
//        config.setJdbcUrl("jdbc:mysql://assignment3.c8smjzr6a1hx.us-west-2.rds.amazonaws.com:3306/assignment2");
//        config.setJdbcUrl("jdbc:mysql://localhost:3306/Assignment2");
        ...
        config.setMaximumPoolSize(59); // Set the maximum number of connections in the pool
